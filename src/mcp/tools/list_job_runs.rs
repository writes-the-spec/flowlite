...
pub struct ListJobRuns {
    ...
    /// Only runs with this status: queued, running, succeeded, failed, skipped, aborted,
    /// timedout or invalid.
...
async fn list_job_runs_rows(
    ...
    crud.select_job_runs(&mut conn, &SelectJobRunsData {
        filter: SelectJobRunsDataFilter { id: None, job_id: job, status, statuses: None, scheduled_at_lte: None, schedule_id: None },
