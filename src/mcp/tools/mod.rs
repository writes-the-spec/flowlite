//! The seven tools, one file each: arguments in, the same CRUD a CLI command runs,
//! structures out.
//!
...
impl McpServer {
    ...
    /// The seven per-tool routers, added together - so a tool is added or removed by adding
